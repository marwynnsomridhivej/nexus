...
class Bot(commands.Bot):
    def __init__(self, config: Config, **kwargs):
        ...
        self.stats_manager: StatsManager = StatsManager(self.config.data_loc)
        ...
        for user in self.users:
            try:
                ...
                if user.dm_channel is None:
                    print(
                        f"No DM Channel exists for user {user.name}, creating...")
